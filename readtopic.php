...
<body>
	<div class="pane">
		<div class="header"><h1><a href="/forum">Български туризъм</a></h1></div>
		<div class="loginpane">
			<?php
				session_start();
		...
		<?php
			...
			echo "<div class='content'><p>Всички отговори (".countReplies($_GET['cid'], $_GET['scid'], $_GET['tid']).")
				  </p></div>";
